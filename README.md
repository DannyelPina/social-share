...
```bash
npm install social-share-toolkit
```
...
```js
SocialShare.createShareBox("#my-container", "https://example.com", "facebook, twitter, whatsapp");
```
...
```tsx
import { SocialShareBox, SocialShareButton } from "social-share-toolkit/react";
...
import SocialShare from "social-share-toolkit/vue";
...
import { SocialShareBox, SocialShareButton } from "social-share-toolkit/vue";
...
```ts
import { getShareUrl, getShareUrls, getSupportedNetworks } from "social-share-toolkit";
```
